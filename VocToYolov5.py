...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_txt", default="/exchange/yolov5-master/data/train_fall.txt")
    parser.add_argument("--test_txt", default="/exchange/yolov5-master/data/val_fall.txt")

    flags = parser.parse_args()

    imgPathList = [
        "/exchange/falldataset/",
        "/exchange/falldataset_A/"
    ]
