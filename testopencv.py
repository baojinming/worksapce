    ...
    for i in np.arange(0, imnorm.shape[0]-1, blockSize):
        for j in np.arange(0, imnorm.shape[1]-1, blockSize):
            ...
            if(blockVar > activityThreshold):
                ...
                # print("blockImpairedtype",type(blockImpaired))
...
if __name__ == "__main__":
    img = cv2.imread("./ice1.jpg")
    # img1= calculate_mscn(img)
    # img1 = segmentEdge(img)
    # cv2.namedWindow('dst')
    # cv2.imshow("dst", img1)
